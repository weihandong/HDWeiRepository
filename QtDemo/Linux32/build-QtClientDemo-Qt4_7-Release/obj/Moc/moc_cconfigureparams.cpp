...
const QMetaObject CConfigureParams::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CConfigureParams,
      qt_meta_data_CConfigureParams, 0 }
};
...
int CConfigureParams::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: loadRemoteParams(); break;
        case 1: on_btnIPParams_clicked(); break;
        case 2: on_btnHardDiskParams_clicked(); break;
        case 3: GetDVRUserID(); break;
        case 4: SetDVRUserID((*reinterpret_cast< long(*)>(_a[1]))); break;
        case 5: showLoginBtn(); break;
        default: ;
        }
        _id -= 6;
    }
