...
const QMetaObject CAlarmParamsDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CAlarmParamsDlg,
      qt_meta_data_CAlarmParamsDlg, 0 }
};
...
int CAlarmParamsDlg::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: changeAlarmInIndex((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: on_checkBoxAlarmInHandle_clicked(); break;
        case 2: on_pushButtonAlarmInHandle_clicked(); break;
        case 3: on_pushButtonPTZ_clicked(); break;
        case 4: on_pushButtonAlarmInSave_clicked(); break;
        case 5: on_pushButtonAlarmOutSave_clicked(); break;
        case 6: changeAlarmOutIndex((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 7: changeAlarmOutDateIndex((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 8;
    }
