...
static const char qt_meta_stringdata_LogTable[] = {
    "LogTable\0"
};

const QMetaObject LogTable::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LogTable,
      qt_meta_data_LogTable, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LogTable::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LogTable))
        return static_cast<void*>(const_cast< LogTable*>(this));
