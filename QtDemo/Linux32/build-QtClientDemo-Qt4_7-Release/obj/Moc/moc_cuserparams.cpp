...
int CUserParams::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: userIDChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: localRightTypeChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: remoteRightTypeChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
