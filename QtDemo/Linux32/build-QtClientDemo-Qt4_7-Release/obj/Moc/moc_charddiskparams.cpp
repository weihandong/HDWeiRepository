...
**
** Created: Sun Dec 1 18:46:56 2019
...
const QMetaObject CHardDiskParams::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CHardDiskParams,
      qt_meta_data_CHardDiskParams, 0 }
};
...
int CHardDiskParams::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_btnHDUpdate_clicked(); break;
        case 1: on_btnHDSave_clicked(); break;
        case 2: on_btnHDGroupUpdate_clicked(); break;
        case 3: on_btnHDGroupSave_clicked(); break;
        case 4: comboHDGroupChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: on_checkAllChan_clicked(); break;
        default: ;
        }
        _id -= 6;
    }
