...
**
** Created: Sun Dec 1 18:46:35 2019
...
int LogSearch::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_comboBox_logtype_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: on_comboBox_maintype_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: on_comboBox_subtype_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: on_dateTimeEdit_start_dateTimeChanged((*reinterpret_cast< const QDateTime(*)>(_a[1]))); break;
        case 4: on_dateTimeEdit_stop_dateTimeChanged((*reinterpret_cast< const QDateTime(*)>(_a[1]))); break;
        case 5: on_pushButton_searchlog_clicked(); break;
