...
const QMetaObject CDlgRemoteRecordSchedule::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CDlgRemoteRecordSchedule,
      qt_meta_data_CDlgRemoteRecordSchedule, 0 }
};
...
int CDlgRemoteRecordSchedule::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_btnCopyDay_clicked(); break;
        case 1: on_btnSave_clicked(); break;
        case 2: { int _r = comboWeekDayChanged((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 3: { int _r = clickRecordAllDay();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        default: ;
        }
        _id -= 4;
