...
#define  NOISE_HUMIDITY_DEVICENAME		"/dev/ttyUSB1"

CSensorNoise::CSensorNoise()
{
	m_MB = NULL;
 ...
 *
 */
bool CSensorNoise::init_Sensor(void)
{
	uint32_t sec = 0;
 ...
 *
 */
int CSensorNoise::get_SensorValue(void)
{
	uint16_t value = 0; 
	...
	if(m_MinValue >= value || m_MaxValue <= value){
		...
		this->m_NoiseValue = value;
		m_Warning = false;
	}	
	
	return this->m_NoiseValue;
 ...
 *
 */
bool CSensorNoise::check_SensorBeWarning(void)
{
	return m_Warning;
}
 ...
 *
 */
void CSensorNoise::set_WarnValue(int warnvalue)
{
 ...
 *
 */
void CSensorNoise::set_RangeValue(int minvalue, int maxvalue)
{
